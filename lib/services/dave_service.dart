...
class DaveService {
  ...
  Future<String?> _captureCommand() async {
    ...
    try {
       ...
       *
       * We pass modelPath directly, pointing at the
       * ggml-base.bin we already downloaded and verified,
       * instead of `model: WhisperModel.base`, which lets
       * the plugin manage (and silently re-fetch) its own
